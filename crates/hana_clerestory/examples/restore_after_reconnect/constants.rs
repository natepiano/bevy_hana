...
pub(super) const FIELD_OUTCOME: &str = "outcome";
...
pub(super) const FIELD_ROLE_STATE: &str = "role_state";
...
// kinds
pub(super) const KIND_ATTEMPT_FINISHED: &str = "attempt-finished";
...
pub(super) const KIND_ROLE_STATE_CHANGED: &str = "role-state-changed";
...
pub(super) const PRODUCER_APPLICATION_RECOVERY_CANCELLATION_REQUESTED: &str =
    "observer::RoleAwaiting::application_consumer";
pub(super) const PRODUCER_ATTEMPT_FINISHED: &str = "observer::AttemptFinished";
...
pub(super) const PRODUCER_MONITOR_DISCONNECTED: &str = "observer::DeviceDeparted";
pub(super) const PRODUCER_RECOVERY_ACCEPTED: &str = "observer::RecoveryPolicyChanged";
pub(super) const PRODUCER_RECOVERY_AVAILABLE: &str = "observer::RoleAvailable";
pub(super) const PRODUCER_RECOVERY_MISMATCH: &str = "observer::WindowRestoreMismatch";
pub(super) const PRODUCER_RECOVERY_PENDING: &str = "observer::RoleAwaiting";
...
pub(super) const PRODUCER_RECOVERY_RESTORE_REQUESTED: &str =
    "observer::RoleAvailable::application_consumer";
pub(super) const PRODUCER_RECOVERY_RESTORED: &str = "observer::WindowRestored";
pub(super) const PRODUCER_ROLE_STATE_CHANGED: &str = "observer::RoleStateChanged";
pub(super) const PRODUCER_STARTUP_SESSION: &str = "Startup::trace_probe_session";
pub(super) const PRODUCER_WINDOW_CREATED: &str = "observer::Add<ProbeWindowRole>";
...
pub(super) const APPLICATION_WINDOW_ROLE: &str = "window:managed:hotplug-application";
...
pub(super) const AUTOMATIC_WINDOW_ROLE: &str = "window:managed:hotplug-automatic";
...
pub(super) const PROBE_WINDOW_COUNT: usize = 4;
